...
function DonorList(){
    ...
    const getData = async () =>{
        const response = await fetch('https://blood-donation-backend-a4xh.onrender.com/getAllDonor');
    ...
    const getDelete = async(id) =>{
        if(window.confirm('Are u sure to delete this record? '))
      {
            ...
            const response = await fetch('https://blood-donation-backend-a4xh.onrender.com/deleteDonor/'+id, requestOptions);
