...
const Forgotpassword = () => {
    ...
    const validateEmail = async () => {
        ...
        const response = await fetch('https://blood-donation-backend-a4xh.onrender.com/send-email', requestOptions);
    ...
    const updatePassword = async () => {
        ...
        if (password == cpassword) {
            const response = await fetch('https://blood-donation-backend-a4xh.onrender.com/changePassword/' + email, requestOptions);
            const data = await response.json();
